# Roadmap
- [x] Apply the Paper/Forest technical-minimalist design system
- [x] Add public landing, pricing, security, and account pages
- [x] Move observability tools into the signed-in dashboard shell
